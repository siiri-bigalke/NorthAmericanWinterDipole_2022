...
zg = np.load('zg_nat.npy') # shape = (34, 170, 72, 144)
tas = np.load('tas_nat.npy') # shape = (34, 170, 72, 144)
nino = np.load('nino_nat.npy') # shape = (34, 170)
...
z250_slope_array = np.save('nat.z250.slope.npy', z250_slope_array)
z250_rvalue_array = np.save('nat.z250.rvalue.npy', z250_rvalue_array)
'''
...
tas_slope_array = np.save('nat.tas.slope.npy', tas_slope_array)
tas_rvalue_array = np.save('nat.tas.rvalue.npy', tas_rvalue_array)
